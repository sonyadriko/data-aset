                ...
                <div class="container-xxl">
                    ...
                    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                        <div class="flex-grow-1">
                            <h4 class="fs-18 fw-semibold m-0">Data Aset yang akan berakhir dalam 1 Bulan</h4>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="table-responsive">
                                            ...
                                            SELECT * 
                                            FROM data_aset 
                                            JOIN PROVINSI ON data_aset.provinsi = provinsi.id 
                                            WHERE tgl_berakhir <= CURDATE() + INTERVAL 14 DAY AND deleted_at IS NULL
                                        ");
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="action-buttons">
                                                                <a href='edit_aset.php?id=<?php echo $id; ?>'
                                                                    class="btn btn-warning btn-user">Ubah</a>
                                                                <a href='detail_aset.php?id=<?php echo $id; ?>'
