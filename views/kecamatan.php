                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="table-responsive">
                                            ...
                                            SELECT kecamatan.id AS id_kecamatan, kecamatan.nama AS nama_kecamatan, kota_kabupaten.nama AS nama_kota_kabupaten
                                            FROM kecamatan 
                                            JOIN kota_kabupaten ON kota_kabupaten.id = kecamatan.kota_kabupaten_id;
                                        ");
                                            // $get_data = mysqli_query($conn, "SELECT * FROM data_aset WHERE deleted_at = NULL");
                                            while($display = mysqli_fetch_array($get_data)) {
                                                $id = $display['id_kecamatan'];
                                                $nama = $display['nama_kecamatan'];
                                                $provinsi = $display['nama_kota_kabupaten']
