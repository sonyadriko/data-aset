...
CREATE TABLE `data_aset` (
  ...
  `skema_kerjasama` varchar(255) NOT NULL,
  `mitra` varchar(255) NOT NULL,
  `bidang_usaha` varchar(255) NOT NULL,
  `luas_objek` varchar(255) NOT NULL,
  ...
  `berkas_shp` varchar(255) DEFAULT NULL,
  `berkas_pks` varchar(255) DEFAULT NULL,
  `file_kmz` varchar(255) DEFAULT NULL,
...
--
ALTER TABLE `kecamatan`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=950833;
